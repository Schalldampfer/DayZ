...
//Spawn probabilities
DZAI_spawnChance0 = 0.90;	//Spawn chance for low-skill AI typically found in small towns (Default: 0.40)
DZAI_spawnChance1 = 0.60;	//Spawn chance for mid-level AI typically found in cities and large towns (Default: 0.60)
DZAI_spawnChance2 = 0.10;	//Spawn chance for high-level AI typically found in places with military-grade loot (Default: 0.80)
DZAI_spawnChance3 = 0.05;	//Spawn chance for expert-level AI found in areas with high-grade military loot (Default: 0.90)
...
DZAI_gradeChances2 = [0.15,0.64,0.20,0.01];
...
DZAI_gradeChances3 = [0.00,0.30,0.55,0.15];
...
DZAI_gradeChancesDyn = [0.80,0.15,0.04,0.01];
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
DZAI_Pistols0 = ["Revolver_DZ","Makarov_DZ","M1911_DZ"]; 				//Weapongrade 0 pistols
DZAI_Pistols1 = ["ItemMap","ItemFlashlight","ItemMatchbox","ItemKnifeBlunt","ItemPickaxeBroken"]; 	//Weapongrade 1 pistols
DZAI_Pistols2 = ["M9_DZ","G17_DZ","ItemFlashlight","ItemRadio"]; 		//Weapongrade 2 pistols
DZAI_Pistols3 = ["Makarov_SD_DZ","PDW_DZ","ItemFlashlightRed","ItemEtool"]; 		//Weapongrade 3 pistols

DZAI_Rifles0 = ["Mosin_DZ","LeeEnfield_DZ","MR43_DZ","Winchester1866_DZ","ItemWatch","ItemCompass","ItemKnife","ItemShovel"]; //Weapongrade 0 rifles
DZAI_Rifles1 = ["MP5_DZ","Remington870_DZ","M1014_DZ","Crossbow_DZ"]; //Weapongrade 1 rifles
DZAI_Rifles2 = ["AK_47_S","AKM_DZ","M14_DZ","AK74_DZ","G36C_DZ","M4A1_FL_DZ","M16A4_DZ","M16A2_DZ","SA58_RIS_DZ","L85A2_DZ","BAF_L85A2_RIS_SUSAT","Bizon_DZ"]; //Weapongrade 2 rifles
DZAI_Rifles3 = ["AK_107_kobra","FNFAL_ANPVS4_DZ","G36K_Camo_DZ","SVD_DZ","AKS74U_SD_DZ","SVD_NSPU_EP1"]; //Weapongrade 3 rifles
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
DZAI_BanditTypes = ["Bandit1_DZ", "BanditW1_DZ"];
...
DZAI_Backpacks2 = ["DZ_Patrol_Pack_EP1","DZ_Czech_Vest_Pouch","DZ_Assault_Pack_EP1","DZ_British_ACU","DZ_TK_Assault_Pack_EP1","DZ_CivilBackpack_EP1","DZ_ALICE_Pack_EP1","DZ_CivilBackpack_EP1","DZ_British_ACU","DZ_Backpack_EP1"];
DZAI_Backpacks3 = ["DZ_CivilBackpack_EP1","DZ_ALICE_Pack_EP1","DZ_CivilBackpack_EP1","DZ_British_ACU","DZ_Backpack_EP1"];
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
_trash=[
"ItemSodaCokeEmpty","ItemSodaPepsiEmpty","ItemSodaMdewEmpty","ItemSodaMtngreenEmpty","ItemSodaR4z0rEmpty","ItemSodaClaysEmpty","ItemSodaSmashtEmpty","ItemSodaDrwasteEmpty","ItemSodaFrankaEmpty","ItemSodaLemonadeEmpty","ItemSodaLirikEmpty","ItemSodaLvgEmpty","ItemSodaMzlyEmpty","ItemSodaPeppsyEmpty","ItemSodaRabbitEmpty","ItemSodaSacriteEmpty","ItemSodaRocketFuelEmpty","ItemSodaGrapeDrinkEmpty","ItemSodaSherbetEmpty",
"FoodCanBeefEmpty","FoodCanPotatoesEmpty","FoodCanGriffEmpty","FoodCanBadguyEmpty","FoodCanBoneboyEmpty","FoodCanCornEmpty","FoodCanCurgonEmpty","FoodCanDemonEmpty","FoodCanFraggleosEmpty","FoodCanHerpyEmpty","FoodCanDerpyEmpty","FoodCanOrlokEmpty","FoodCanPowellEmpty","FoodCanTylersEmpty","FoodCanUnlabeledEmpty","FoodCanRusUnlabeledEmpty","FoodCanRusStewEmpty","FoodCanRusPorkEmpty","FoodCanRusPeasEmpty","FoodCanRusMilkEmpty","FoodCanRusCornEmpty",
"TrashTinCan","TrashJackDaniels","ItemSodaEmpty","ItemCards","ItemKosmosSmokes","ItemTrashPaperMusic","ItemTrashRazor","ItemTrashToiletpaper"
];

DZAI_Edibles = _trash + ["ItemSodaCoke", "ItemSodaPepsi", "ItemWaterbottle", "FoodCanSardines", "FoodCanBakedBeans", "FoodCanFrankBeans", "FoodCanPasta", "ItemWaterbottleUnfilled","ItemWaterbottleBoiled","FoodmuttonCooked","FoodchickenCooked","FoodBaconCooked","FoodRabbitCooked","FoodbaconRaw","FoodchickenRaw","FoodmuttonRaw","foodrabbitRaw","FoodCanUnlabeled","FoodPistachio","FoodNutmix"];
DZAI_Medicals1 = ["ItemHeatpack", "ItemBandage", "ItemPainkiller","ItemEpinephrine"];
DZAI_Medicals2 = ["ItemAntibacterialWipe", "ItemPainkiller", "ItemMorphine", "ItemBandage", "transfusionKit", "ItemAntibiotic", "wholeBloodBagANEG","wholeBloodBagAPOS","wholeBloodBagBNEG","wholeBloodBagBPOS","wholeBloodBagABNEG","wholeBloodBagABPOS","wholeBloodBagONEG","wholeBloodBagOPOS"];
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
DZAI_MiscItemS = _trash + ["HandRoadFlare", "HandChemBlue", "HandChemRed", "HandChemGreen","SmokeShell"];
DZAI_MiscItemL = ["HandRoadFlare", "ItemJerrycan", "PartWheel", "PartEngine", "PartFueltank", "PartGlass", "PartVRotor","PartWoodPile", "equip_crate"];
