...
class CfgLoot
{
	class Groups
	{
		...
		// General groups
		#include "\z\addons\dayz_code\Configs\CfgLoot\Groups\Ammo.hpp"
		#include "\z\addons\dayz_code\Configs\CfgLoot\Groups\AmmoBox.hpp"
		#include "\z\addons\dayz_code\Configs\CfgLoot\Groups\Attachments.hpp"
		#include "\z\addons\dayz_code\Configs\CfgLoot\Groups\Medical.hpp"
		...
		#include "\z\addons\dayz_code\Configs\CfgLoot\Groups\Fuel.hpp"
		#include "\z\addons\dayz_code\Configs\CfgLoot\Groups\Parts.hpp"
		
		// Points of interest
		#include "\z\addons\dayz_code\Configs\CfgLoot\Groups\CrashSite.hpp"
		#include "\z\addons\dayz_code\Configs\CfgLoot\Groups\CarePackage.hpp"
		#include "\z\addons\dayz_code\Configs\CfgLoot\Groups\InfectedCamp.hpp"
		...
		#include "\z\addons\dayz_code\Configs\CfgLoot\Groups\Buildings\Construction.hpp"
		#include "\z\addons\dayz_code\Configs\CfgLoot\Groups\Buildings\Farm.hpp"
		#include "\z\addons\dayz_code\Configs\CfgLoot\Groups\Buildings\Hospital.hpp"
		#include "\z\addons\dayz_code\Configs\CfgLoot\Groups\Buildings\Hunting.hpp"
		#include "\z\addons\dayz_code\Configs\CfgLoot\Groups\Buildings\Industrial.hpp"
		#include "\z\addons\dayz_code\Configs\CfgLoot\Groups\Buildings\Military.hpp"
		...
		#include "\z\addons\dayz_code\Configs\CfgLoot\Groups\Buildings\Residential.hpp"
