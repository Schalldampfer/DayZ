...
#define START_ITEMS "ItemBandage",2,"ItemAntibacterialWipe","ItemSodaCoke","FoodPistachio","ItemBookBible"
#define START_TOOLS "Item3Matchbox","MeleeFlashlight"
class_public = [ // These are visible to anyone on the server
	[localize "str_playerstats_bandit","Bandit1_DZ","BanditW1_DZ",[START_ITEMS],[START_TOOLS],"DZ_Czech_Vest_Pouch",["HandRoadFlare"],[],0,-1,0,"MeleeCrowbar"],
	[localize "str_playerstats_hero","Survivor3_DZ","SurvivorW2_DZ",[START_ITEMS],[START_TOOLS],"DZ_ALICE_Pack_EP1",["HandRoadFlare"],[],0,5000,0,"MeleeHatchet"],
	[localize "str_playerstats_survivor","Survivor2_DZ","SurvivorW2_DZ",[START_ITEMS],[START_TOOLS],"DZ_Patrol_Pack_EP1",["HandRoadFlare"],[],0,0,0,"MeleeBaseBallBat"]
];
