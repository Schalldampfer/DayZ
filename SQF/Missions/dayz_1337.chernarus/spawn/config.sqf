...
#define START_TOOLS "Item3Matchbox","ItemRadio"
class_public = [ // These are visible to anyone on the server
	[localize "str_playerstats_bandit","Bandit1_DZ","BanditW1_DZ",[START_ITEMS,"8Rnd_9x18_Makarov",2],[START_TOOLS,"ItemFlashlight","Makarov_DZ"],"DZ_Czech_Vest_Pouch",["HandRoadFlare"],[],0,-1,0,"MeleeCrowbar"],
	[localize "str_playerstats_hero","Survivor3_DZ","SurvivorW2_DZ",[START_ITEMS,"15Rnd_W1866_Slug",2],[START_TOOLS,"MeleeFlashlight","Winchester1866_DZ"],"DZ_ALICE_Pack_EP1",["HandRoadFlare"],[],0,5000,0,"MeleeHatchet"],
	[localize "str_playerstats_survivor","Survivor2_DZ","SurvivorW2_DZ",[START_ITEMS,"2Rnd_12Gauge_Buck",2,"2Rnd_12Gauge_Slug"],[START_TOOLS,"MeleeFlashlight","MR43_DZ"],"DZ_Patrol_Pack_EP1",["HandRoadFlare"],[],0,0,0,"MeleeBaseBallBat"]
];
